...
zokou({
  ...
  try {
    ...
    if (_0x12db33 && _0x12db33.length > 0) {
      ...
      const _0xd7e532 = await fetch("https://api.ibrahimadams.us.kg/api/download/ytmp3?url=" + encodeURIComponent(_0x330f0e) + "&apikey=" + "abutech");
...
zokou({
  ...
  try {
    ...
    if (_0x4fca54 && _0x4fca54.length > 0) {
      ...
      const _0x2f521e = await fetch("https://api.ibrahimadams.us.kg/api/download/ytmp3?url=" + encodeURIComponent(_0x36a56e) + "&apikey=" + "abutech");
...
zokou({
  ...
  try {
    ...
    if (_0x543d5b && _0x543d5b.length > 0) {
      ...
      const _0x4dc9ed = await fetch("https://api.ibrahimadams.us.kg/api/download/ytmp4?url=" + encodeURIComponent(_0x3f96dc) + "&apikey=" + "abutech");
...
zokou({
  ...
  try {
    ...
    if (_0x591ca1 && _0x591ca1.length > 0) {
      ...
      const _0x16a65d = await fetch("https://api.ibrahimadams.us.kg/api/download/ytmp4?url=" + encodeURIComponent(_0x27d7ee) + "&apikey=" + "abutech");
